package programacion.tema11.Ejercicios.ejercicio2;

import java.util.LinkedList;
import java.util.Scanner;

/**
 * 1. Realizar un programa que contenga una LinkedList para almacenar las matrículas de los
...
public class Parking {
    ...
    public void aparcar(String matriucla){
        if(parking.size()<10) parking.push(matriucla);
        else System.out.println("Parking lleno");
    }

    public void desaparcar(){
        if(!parking.isEmpty()) System.out.println("Matricula que sale: "+parking.pop());
        else System.out.println("El parking esta vacio");
        
    }

    public void mostrarMatriculas(){
        if(parking.isEmpty()) System.out.println("El parking esta vacio");
