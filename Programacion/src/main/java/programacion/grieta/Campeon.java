...
public class Campeon extends Personajes{
    ...
    /**
     * Constructor de campeon, se le asignara un nombre y el id empezara en 1 y se ira incrementando conforme vayamos creando mas
    ...
    public void RecibirHabilidad(int daño) {
        if(!esquivar()){
            ...
            System.out.println("Soy el campeon "+id+" y he recibido "+daño+" puntos de daño, me quedan "+vida+" puntos de vida");
        } else {
            System.out.println("Soy el campeon "+id+ " y he esquivado el ataque, me quedan "+vida+" puntos de vida");
        }
