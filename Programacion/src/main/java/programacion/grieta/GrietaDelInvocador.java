...
/**
 * 
    Mientras haya al menos un personaje vivo en cada equipo, los personajes atacan en turnos.
    Se elige un personaje aleatorio de cada equipo para atacar al enemigo, se irán alternando los equipos en atacar primero, también es aleatorio al personaje que se ataca. Si se te ocurre otra forma de combate puedes especfificarla. Si necesitas algún método nuevo, especifícalo.
    Si un equipo pierde a todos sus miembros, la batalla termina y el otro equipo es declarado ganador.
