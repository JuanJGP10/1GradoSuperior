...
/**
 * Clase equipo que nos servira para formar los equipos de la grieta del
 * invocador para dar inicio a la batalla
 */
public class Equipo {
    ...
    /**
     * Constructor de quipos que si campeon es verdadero, generara un equipo de
     * campeones y si es falso lo hara de criaturas del vacio
     * 
     ...
     * 
     * @param indice Un personaje en la posición indice del equipo recibe un ataque
     *               con esa cantidad de daño.
     * @param daño   cantidad de daño
     *               Si la posición es inválida o el personaje ya está muerto, no
     *               ocurre nada.
     */
